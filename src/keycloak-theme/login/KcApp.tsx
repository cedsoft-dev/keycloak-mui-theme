                    ...
                    {(() => {
                        switch (kcContext.pageId) {
                            ...
                            case "login-config-totp.ftl":
                                return <LoginConfigTotp {...{kcContext, i18n, Template, classes}}
                                                        doUseDefaultCss={true}/>;
                            ...
                            case "login-password.ftl":
                                return <LoginPassword {...{kcContext, i18n, Template, classes}}
                                                      doUseDefaultCss={true}/>;
                            ...
                            case "login-username.ftl":
                                return <LoginUsername {...{kcContext, i18n, Template, classes}}
                                                      doUseDefaultCss={true}/>;
